          ...
          <td style="text-align:center; padding-bottom:16px;">
            <table cellpadding="0" cellspacing="0" border="0" align="center" style="margin-bottom:18px;">
              <tr>
                ...
                <td style="padding:0 8px;">
                  <a href="https://github.com/saichaitanyadasari99-lab" target="_blank" style="display:inline-block; width:34px; height:34px; background-color:#e5e7eb; border-radius:50%; text-align:center; line-height:34px;">
                    <svg viewBox="0 0 16 16" width="16" height="16" fill="#374151" style="vertical-align:middle;">
